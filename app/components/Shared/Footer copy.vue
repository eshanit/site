  ...
  <footer class="bg-gradient-to-b from-gray-900 to-gray-950 text-white relative overflow-hidden">
    ...
    <div class="absolute inset-0 opacity-5">
      <div 
        v-for="i in 8" 
        :key="i"
        class="absolute rounded-full bg-gradient-to-r from-brand-medium to-brand-darkest"
        :style="{
            ...
            <div class="space-y-6">
              <NuxtLink to="/" class="inline-block">
                <div class="flex items-center space-x-3 group">
                  <div class="relative">
                    <div class="absolute -inset-4 bg-gradient-to-r from-brand-medium to-brand-darkest opacity-20 blur group-hover:opacity-30 transition-opacity duration-500"></div>
                    <div class="relative bg-white p-2.5 shadow-lg border border-gray-100">
                      <!-- <AppFooterLogo size="md" /> -->
                    </div>
                  </div>
                  <div>
                    <div class="text-2xl font-bold bg-gradient-to-r from-brand-light to-brand-medium bg-clip-text text-transparent">
                      PEGISUS
                    </div>
